...
//Groups
let kUserGroups = "api/social-connect/get-user-groups"
let kCreateGroup = "api/social-connect/create-group"
let kGroupIdDetails = "api/social-connect/get-group-details?group_id=%@"
let kGroupDiscussions = "api/social-connect/get-group-discussions"
let kUpdateGroupDescription = "api/social-connect/update-group_description"
let kShareGroup = "api/social-connect/share-group"
let kUpdateUserGroupStatus = "api/social-connect/update-user-group-status"
let kGetGroupMembers = "api/social-connect/get-group-members?group_id=%@"
let kPinPost = "api/social-connect/pin-a-post"
let kUnPinPost = "api/social-connect/unpin-a-post"
let kReportGroupSharedPost = "api/social-connect/report-group-post"
let kGroupAdminApproveOrRejectMember = "api/social-connect/group-admin-approve-or-reject-member-in-group"
let kChangeGroupMemberPrivilege = "api/social-connect/change-group-member-privilege"
let kLeaveMemberFromGroup = "api/social-connect/leave-member-from-group"
let kGetGroupEvents = "api/social-connect/load-all-events?group_id=%@"
let kCreateGroupEvent = "api/social-connect/create-user-event"
let kDeleteGroupEvent = "api/social-connect/delete-event"
let kUpdateGroupEvent = "api/social-connect/update-user-event"
let kStoreEventRSVP = "api/social-connect/store-event-RSVP"
