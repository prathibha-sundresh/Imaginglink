//
//  SharedStatusTableViewCell.swift
//  ImaginingLink
//
...
@objc protocol SharedStatusTableViewCellDelegate {
    func getLikedStatus(row: Int)
    func updateRatingWithIndex(row: Int, rating: Int)
	@objc optional func showMoreImages(imagesList: [String], index:Int, imageIndex: Int)
}

class SharedStatusTableViewCell: UITableViewCell {
